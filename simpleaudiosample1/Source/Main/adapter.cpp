...
#define IOCTL_PUSH_DATA CTL_CODE(FILE_DEVICE_UNKNOWN, 0x2049, METHOD_BUFFERED, FILE_WRITE_ACCESS)
...
--*/
    ...
    //
    //DriverObject->MajorFunction[IRP_MJ_DEVICE_CONTROL] = ControlHandle;
